...
?><div class="bDiv" >
		...
		<thead>
			<tr class='hDiv'>
				...
				<th width='<?php echo $column_width?>%' class="change-width-xs">
...
<?php foreach($list as $num_row => $row){ ?>        
		<tr  <?php if($num_row % 2 == 1){?>class="erow"<?php }?>>
			<?php foreach($columns as $column){?>
			<td width='<?php echo $column_width?>%' class='change-width-xs <?php if(isset($order_by[0]) &&  $column->field_name == $order_by[0]){?>sorted<?php }?>'>
